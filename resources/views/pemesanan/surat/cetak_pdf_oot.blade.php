...
<body>
    ...
    <!-- Isi Laporan -->
    <div class="content">
        <h2 class="title-surat">Surat Pesanan Obat-Obat Tertentu</h2>
    ...
    <div class="notes">
        <p>*) Sebutkan nama obat, bentuk sediaan, kekuatan/potensi, jumlah dalam angka & huruf</p>
        <p>Cat: surat pesanan dibuat sekurang-kurangnya 3 (tiga) rangkap</p>
    </div>
</body>
