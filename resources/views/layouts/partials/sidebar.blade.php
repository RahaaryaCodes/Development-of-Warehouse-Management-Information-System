<aside id="sidebar" class="sidebar">
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('data-*') ? '' : 'collapsed' }}" data-bs-target="#master-data-nav" data-bs-toggle="collapse" href="#">
     ...
     <!-- Stok Obat -->
     <li class="nav-item">
      <a class="nav-link {{ Request::is('stok-*') ? '' : 'collapsed' }}" data-bs-target="#stok-nav" data-bs-toggle="collapse" href="#">
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('pemesanan-barang', 'penerimaan-barang', 'penjualan') ? '' : 'collapsed' }}" data-bs-target="#transaksi-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-cart"></i><span>Transaksi</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="transaksi-nav" class="nav-content collapse {{ Request::is('pemesanan-barang', 'penerimaan-barang', 'penjualan') ? 'show' : '' }}">
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('laporan-*') ? '' : 'collapsed' }}" data-bs-target="#laporan-nav" data-bs-toggle="collapse" href="#">
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('profile', 'manajemen-user', 'logout') ? '' : 'collapsed' }}" data-bs-target="#pengaturan-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-gear"></i><span>Pengaturan</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="pengaturan-nav" class="nav-content collapse {{ Request::is('profile', 'manajemen-user', 'logout') ? 'show' : '' }}">
        ...
        <li><a href="{{ route('logout') }}" class="{{ Request::is('logout') ? 'active' : '' }}"><i class="bi bi-circle"></i>Logout</a></li>
      </ul>
    </li>
  </ul>
</aside>
